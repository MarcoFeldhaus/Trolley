...
# Einfach den gewünschten Shop dekommentieren und ggf. weitere Shops hinzufügen. 
# Wichtig: Es müssen gültige API-Zugangsdaten (Consumer Key und Consumer Secret) für jeden Shop angegeben werden, 
# damit die Bestellungen erfolgreich abgerufen werden können. Die URL muss auf die jeweilige Shop-Domain angepasst werden.
shops = [
#  {
#         "name": "0711Card",
...
if USE_CUSTOM_RANGE:
    EXPORT_START = "2026-02-01"
    EXPORT_END = "2026-02-28"
...
for shop in shops:
    ...
    while True:
        ...
        for order in orders:
            ...
            # Debug-Ausgabe für Order-Meta-Daten
            # print(f"\nORDER ID: {order.get('id')}")
            # for meta in order_meta:
            #     print(meta.get("key"), "=", repr(meta.get("value")))
            # print("------")
...
#output_file = f"lle_bestellungen_pro_shop_{today.strftime('%Y-%m-%d')}.xlsx"
output_file = f"alle_bestellungen__herbolzheim_ettenheim.xlsx"
