...
$options = array('type'=>'', 'enc'=>'', 'flags'=>32, 'outpath'=>TM_K_PATH_FONTS, 'platid'=>3, 'encid'=>1, 'addcbbox'=>false, 'link'=>false);
...
foreach ($options['fonts'] as $font) {
	...
	$fontname = TM_TCPDF_FONTS::addTTFfont($fontfile, $options['type'], $options['enc'], $options['flags'], $options['outpath'], $options['platid'], $options['encid'], $options['addcbbox'], $options['link']);
	if ($fontname === false) {
		$errors = true;
